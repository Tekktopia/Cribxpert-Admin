...
const SupportDash = () => {
      ...
      const displayedTickets = useMemo(() => {
            if (showAllTickets) {
                  return filteredTickets; // Show all tickets
            } else {
                  return filteredTickets.slice(0, 3); // Show only first 3
            }
            ...
            const handleTicketClick = (ticket: Ticket) => {
                  ...
                  console.log("Opening complaint:", ticket.ticketId);
            };
            ...
            const handleSeeAllClick = () => {
                  setShowAllTickets(!showAllTickets); // Toggle between show all and show 3
