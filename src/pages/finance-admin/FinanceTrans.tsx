...
export default function FinanceTrans() {
  ...
  return (
    <PageWrapper
      title="Transactions"
      subtitle="Clear record of all financial movements: booking payments, commissions, refunds and payouts"
      isPopulated={true}
          ...
          <table className="w-full text-left border-collapse min-w-[900px]">
              <thead className="bg-white border-b border-gray-100">
                  <tr>
                      ...
                      <Th sort className="min-w-[120px]">Type</Th>
                      <Th className="min-w-[140px]">User</Th>
                      <Th className="min-w-[100px]">Amount</Th>
                      <Th className="min-w-[100px]">Commission</Th>
                      <Th className="min-w-[100px]">Status</Th>
                      <Th sort className="min-w-[120px]">Date & Time</Th>
                      <Th sort className="min-w-[110px]">Payment Method</Th>
                  ...
                  {filteredData.map((tx) => {
                      ...
                      return (
                          <tr key={tx.id} className="hover:bg-gray-50 transition-colors bg-white">
                              <Td className="font-medium text-gray-900 min-w-[120px]">{tx.transactionId || tx.id}</Td>
                              <Td className="min-w-[120px]">{tx.type}</Td>
                              <Td>
                              ...
                              <Td className="min-w-[100px]">{commission}</Td>
                              <Td className="min-w-[100px]"><StatusBadge status={tx.status} /></Td>
                              ...
                              <Td className="min-w-[110px]">{paymentMethod}</Td>
